...
georep.addProbability(data=data, geoX='PHI',geoY='C-1:C',title='Phi-C-1:CB', palette='nipy_spectral_r')

georep.addScatter(data=data, geoX='PSI',geoY='CA-1:CA:CA+1',hue='resolution', title='PSI-Backbone tau', palette='viridis_r')
georep.addProbability(data=data, geoX='PSI',geoY='CA-1:CA:CA+1',title='PSI-Backbone tau', palette='nipy_spectral_r')

georep.addScatter(data=data, geoX='TAU',geoY='PSI',hue='resolution', title='Tau-Psi', palette='viridis_r')
georep.addProbability(data=data, geoX='TAU',geoY='PSI',title='Tau-Psi', palette='nipy_spectral_r')

georep.addScatter(data=data, geoX='CA-2:CA-1:CA',geoY='CA:CA+1:CA+2',hue='resolution', title='Backbone taus', palette='viridis_r')
georep.addProbability(data=data, geoX='CA-2:CA-1:CA',geoY='CA:CA+1:CA+2',title='backbone taus', palette='nipy_spectral_r')
