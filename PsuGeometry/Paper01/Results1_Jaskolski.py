...
georep.addHistogram(data=data2,geoX='N:CA', title='1000>0.9 N:CA', exclusions={'aa': 'PRO,GLY'})
georep.addHistogram(data=data2,geoX='CA:C', title='1000>0.9 CA:C', exclusions={'aa': 'GLY'})
georep.addHistogram(data=data2,geoX='C-1:N', title='1000>0.9 C-1:N', exclusions={'aa': 'PRO'})
georep.addHistogram(data=data2,geoX='C:O', title='1000>0.9 C:O')
