...
dihs = ['PSI','PHI']
angles = ['TAU']
distances = ['N-6:O','N-5:O','N-4:O','N-3:O','N-2:O','N+2:O','N+3:O','N+4:O','N+5:O','N+6:O',
             'O-6:N','O-5:N','O-4:N','O-3:N','O-2:N','O+2:N','O+3:N','O+4:N','O+5:N','O+6:N',] # OCA
...
for i in range(0,len(datas)):
    ...
    for aa in aas:
        ...
        georepData.printToHtml('Tau CA Correlations ' + aa + ' Plots, Pdbs=' + tag + str(len(pdbList1000)) , 5, 'Results2_' + aa + '_tauHB_' + tag + str(len(pdbList1000)))
