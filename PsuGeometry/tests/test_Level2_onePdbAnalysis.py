...
singlePdb = '6xe9'# Analyse a single pdb
#########################################################################################

print('---Set data lists up...')
pdbList = [singlePdb]
geoList = ['CA:C','N:CA','C:O','PHI','PSI','OMEGA','TAU','C-1:N','C:N+1','N:O','C-1:C','N:CA:C:O']
...
georep = psu.GeoReport(pdbList,pdbDataPath,edDataPath,printPath,ed=False,dssp=True)
