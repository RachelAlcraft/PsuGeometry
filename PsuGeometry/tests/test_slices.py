...
length = 6
gaps = 0.1
interpmethod = 'linear' #linear or nearest or spline or sphere
central_atom = 'C'
linear_atom = 'N'
linear_offset = 1
planar_atom = 'O'
...
for pdbCode in pdbCodes:
    ...
    georep.printToHtml(pdbCode.upper() + ' Peptide Bond Density/Difference Overlay ' + interpmethod, 3,  pdbCode + interpmethod + '_overlay')
