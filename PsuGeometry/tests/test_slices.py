...
for pdbCode in pdbCodes:
    ...
    georep = geor.GeoReport([pdbCode], pdbDataPath, edDataPath, printPath)
    georep.addSurfaceOverlay(surfaces, palette=palette, title='Overlay No Pro', logged=False)
    georep.addSurfaceOverlay(surfacespro, palette=palette, title='Overlay No With Pro', logged=False)

    georep.printToHtml(pdbCode.upper() + ' ' + matstring + ' Peptide Bond Density Slices', 2,  pdbCode + '_overdens')
