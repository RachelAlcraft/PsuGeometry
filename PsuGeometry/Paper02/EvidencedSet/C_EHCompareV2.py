...
def EHCompare(pdbSet, dataBest,tag):
    ...
    georepSummary.printToHtml('Best Supported Engh&Huber Compare, set=' + pdbSet, 4,'Defensible_EH_' + pdbSet + tag)
    ...
    for aa in aas:
        ...
        georepAA.printToHtml(aa + ' Best Supported Engh&Huber Compare, set=' + pdbSet + '_AA', 4,'Defensible_EH_' + pdbSet + tag + '_' + aa)
